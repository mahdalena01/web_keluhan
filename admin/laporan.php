        <div class="row">
          <div class="col s12 m9">
            <h3 class="blaack-text"style="text-align:center"><b>Cetak Laporan</h3></b>
          </div> 
          <div class="col s12 m3">
            <div class="section"></div>
            <a class=" btn red" href="cetak.php"><i class="material-icons">print</i></a>
          </div>
        </div>
	...
	<?php 
		...
		<tr>
			...
			<td><a class="btn blue modal-trigger black" href="#laporan?id_tanggapan=<?php echo $r['id_tanggapan'] ?>"><b>Lihat</a></b></td>
