        <div class="row">
          <div class="col s12 m9">
            <h3 class="black-text"style="text-align:center"><b>Admin / Petugas</h3></b>
          </div>  
          <div class="col s12 m3">
            <div class="section"></div>
            <a class="btn modal-trigger orange" href="#modal1"><i class="material-icons">add </i>Tambah User</a>
          </div>
        </div>
	...
	<?php 
		...
		<tr>
			...
			<td><a class="btn black modal-trigger" href="#user_edit<?php echo $r['id_petugas'] ?>"><b>Edit</a></b> <a class="red btn" onclick="return confirm('Anda Yakin Ingin Menghapus Ya/Tidak')" href="index.php?p=user_hapus&id_petugas=<?php echo $r['id_petugas'] ?>"><b>Hapus</a></b></td>
        ...
        <div id="user_edit<?php echo $r['id_petugas'] ?>" class="modal">
          <div class="modal-content">
			...
			<form method="POST">
				...
				<div class="col s12 input-field">
					<input type="submit" name="Update" value="Simpan" class="btn right orange">
				</div>
			</form>
...
<!-- ------------------------------------------------------------------------------------------------------------------------------------ -->
        ...
        <div id="modal1" class="modal">
          <div class="modal-content">
            <h4 style="text-align:center"><b>Tambah Data</h4></b>
			<form method="POST">
				<div class="col s12 input-field">
					<label for="nama">Nama</label>
