        <div class="row">
          <div class="col s12 m9">
            <h3 class="black-text"style="text-align:center"><b>Pengaduan</h3></b>
          </div>
        </div>
	...
	<?php 
		...
		<tr>
			...
			<td><a class="btn modal-trigger black" href="#more?id_pengaduan=<?php echo $r['id_pengaduan'] ?>"><b>Lihat</a></b>  <a class="btn red" onclick="return confirm('Anda Yakin Ingin Menghapus Ya/Tidak')" href="index.php?p=pengaduan_hapus&id_pengaduan=<?php echo $r['id_pengaduan'] ?>"><b>Hapus</a></td></b>

<!-- ------------------------------------------------------------------------------------------------------------------------------------ -->
        <!-- Modal Structure -->
        <div id="more?id_pengaduan=<?php echo $r['id_pengaduan'] ?>" class="modal">
          <div class="modal-content">
            <h4 class="black-text" style="text-align:center"><b>Detail</h4></b>
            ...
            <?php 
	            ...
	            <div class="col s12 m6">
					<form method="POST">
						...
						<div class="col s12 input-field">
							<input type="submit" name="tanggapi" value="Kirim" class="btn right black">
						</div>
					</form>
	            </div>
            <?php	}
